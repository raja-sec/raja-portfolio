...
export default function ArticleDetail() {
  ...
  return (
    <div className="container mx-auto px-4 py-20 mt-16 max-w-4xl text-gray-200">
      ...
      {/* Subject Badge - Prominent Display */}
      <div className="mb-6">
        <SubjectBadge subject={meta.subject} size="md" />
      </div>


      {/* Title */}
      <h1 className="text-4xl md:text-5xl text-pink-300 font-bold mb-8 leading-tight">
        {meta.title}
      </h1>

      {/* Date */}
      <p className="text-sm text-gray-400 mb-4">{meta.date}</p>
